def game_events(choice):
  if choice.text == "You take the left path":
    ...
    print("Suddenley the statue moves toward you, it's eyes glowing blue, it presents you with a mysterious sword!")
    print("The sword has a blade that glows teal. The hilt is made from a lustrious metal. It is possible it is not of this galaxy")
    print("It seems you may have been chosen for a higher purpose.")
